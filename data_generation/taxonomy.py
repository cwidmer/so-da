...
def create_tax_eight():
    ...
    escherichia: Bacteria; Proteobacteria; Gammaproteobacteria; Enterobacteriales; Enterobacteriaceae; Escherichia; Escherichia coli;
    agrobacterium: Bacteria; Proteobacteria; Alphaproteobacteria; Rhizobiales; Rhizobiaceae; Rhizobium/Agrobacterium group; Agrobacterium; Agrobacterium tumefaciens; Agrobacterium tumefaciens str. C58
    helicobakter: Bacteria; Proteobacteria; Epsilonproteobacteria; Campylobacterales; Helicobacteraceae; Helicobacter; Helicobacter pylori; Helicobacter pylori 26695
    
    mycoplasma: Bacteria; Tenericutes; Mollicutes; Mycoplasmatales; Mycoplasmataceae; Mycoplasma; Mycoplasma genitalium
    bacillus: Bacteria; Firmicutes; Bacillales; Bacillaceae; Bacillus; Bacillus cereus group; Bacillus anthracis; Bacillus anthracis str. 'Ames Ancestor'

    mycobacteria: Bacteria; Actinobacteria; Actinobacteridae; Actinomycetales; Corynebacterineae; Mycobacteriaceae; Mycobacterium; Mycobacterium tuberculosis complex; Mycobacterium tuberculosis; Mycobacterium tuberculosis H37Rv
    Acidobacterium capsulatum: Bacteria; Acidobacteria; Acidobacteriales; Acidobacteriaceae; Acidobacterium; Acidobacterium capsulatum; Acidobacterium capsulatum ATCC 51196
    """
